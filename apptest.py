...
product_data = pd.read_csv('D:\AI\店商推薦\程式\data_processing\product_data\ML\進azure的資料\product_all.csv')
discounted_products = pd.read_csv('D:\AI\店商推薦\程式\data_processing\product_data\\product_discount.csv')#放折價
hot_sale = pd.read_csv('D:\AI\店商推薦\程式\data_processing\product_data\ML\網頁\\top_buying.csv')#放熱門
